 ...
 * {@code MimicReplayProtocol.PacingRecorder}, which is written only by the replay thread).
 *
 * <p><b>Note:</b> deliberately duplicated in {@code framed-streamer}. Leaf modules must not
